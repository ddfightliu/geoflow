  ...
  data() {
    return {
      ...
      commands: [
        ...
        { id: 'new-project', name: 'File: New Project', description: 'Create a new project' },
        ...
        { id: 'save-as', name: 'File: Save As', description: 'Save the current file with a new name' },
        { id: 'save-all', name: 'File: Save All', description: 'Save all open files' },
        { id: 'close-file', name: 'File: Close', description: 'Close the current file', shortcut: 'Ctrl+W' },
        { id: 'undo', name: 'Edit: Undo', description: 'Undo the last action', shortcut: 'Ctrl+Z' },
        { id: 'redo', name: 'Edit: Redo', description: 'Redo the last undone action', shortcut: 'Ctrl+Y' },
        { id: 'cut', name: 'Edit: Cut', description: 'Cut the selected text', shortcut: 'Ctrl+X' },
        { id: 'copy', name: 'Edit: Copy', description: 'Copy the selected text', shortcut: 'Ctrl+C' },
        { id: 'paste', name: 'Edit: Paste', description: 'Paste the clipboard content', shortcut: 'Ctrl+V' },
        { id: 'find', name: 'Edit: Find', description: 'Find text in the current file', shortcut: 'Ctrl+F' },
        { id: 'replace', name: 'Edit: Replace', description: 'Find and replace text', shortcut: 'Ctrl+H' },
